...
print.resume <- function(x, ...) {
  ascii:::show.rest.table(unclass(x), include.rownames = TRUE, include.colnames = TRUE, header = TRUE)
  invisible(x)
}
...
print.resume.by <- function(x, ...) {
  ...
  ascii:::show.rest.table(xx, lgroup = attr(x, "lgroup"), n.lgroup = attr(x, "n.lgroup"), include.rownames = include.rownames, include.colnames = TRUE, header = TRUE)
  invisible(x)
}
...
print.correlation <- function(x, ...) {
  ascii:::show.rest.table(x, include.rownames = TRUE, include.colnames = TRUE, header = TRUE)
  invisible(x)
}
